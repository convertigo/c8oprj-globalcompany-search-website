			...
			<div id="header">
				<div class="centerbloc">
					...
					<xsl:call-template name="header">
						<xsl:with-param name="subtitle">Customer Search - Advanced Search</xsl:with-param>
					</xsl:call-template>
					...
					<xsl:choose>
						<xsl:when test="authenticated">
							...
							<p>
								...
								<!-- Lien Quick search -->
					        	<a href=".cxml?__sequence=searchCustomerForm" id="quickSearch">Quick search</a>
							</p>
						
							<!-- search form -->
							<form id="advancedSearch" action="index.html" method="GET">
								<p><span>Name: </span><input type="text" id="advancedSearch_name" name="name"/></p>
							    <p><span>Firstname: </span><input type="text" id="advancedSearch_fisrtname" name="firstname"/></p>
							    <p><span>Company: </span><input type="text" id="advancedSearch_company" name="company"/></p>
							    <input type="submit" id="advancedSearch_button" name="button" value="Search"/>
								<input type="hidden" id="advancedSearch_sequence" name="__sequence" value="searchCustomerAdvanced"/>
								<input type="hidden" id="advancedSearch_start" name="start" value="0"/>
					        </form>
	        				<p class="info">Each keyword is searched among the respective column: customers name, firstname and company names.</p>
