			...
			<div id="header">
				<div class="centerbloc">
					...
					<xsl:call-template name="header">
						<xsl:with-param name="subtitle">Business Search - Advanced Search</xsl:with-param>
					</xsl:call-template>
					...
					<xsl:choose>
						<xsl:when test="authenticated">
							...
							<p>
								...
								<!-- Lien Quick search -->
					        	<a href=".cxml?__sequence=searchBusinessForm" id="quickSearch">Quick search</a>
							</p>
						
							<!-- search form -->
							<form id="businessAdvancedSearch" action="index.html" method="GET">
								<p><span>Project: </span><input type="text" id="businessAdvancedSearch_project_name" name="projectName"/></p>
							    <p><span>Company: </span><input type="text" id="businessAdvancedSearch_company" name="company"/></p>
							    <input type="submit" id="businessAdvancedSearch_button" name="button" value="Search"/>
								<input type="hidden" id="businessAdvancedSearch_sequence" name="__sequence" value="searchBusinessAdvanced"/>
								<input type="hidden" id="businessAdvancedSearch_start" name="start" value="0"/>
					        </form>
	        				<p class="info">Each keyword is searched among the respective column: project and company names.</p>
